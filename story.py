...
def not_start_game():
    """
    If the player chooses 2. No when asked
    to proceed into the office.
    """
...
def welcome():
    """
    Welcome speech and player gets to
    introduce themselves.
    Includes a short loop to check that
    the player has entered a name that doesn't
    include any integers
    """
...
def intro_text():
    """
    Introduction text to the start of the
    "actual" game
    """
...
def room_four_text():
    """
    Introduction to Room four.
    Room offers the choice to rest that, if taken,
...
def room_four_4_rest():
    ...
    print("made it out alive, given the complexity of the building.\n")
    time.sleep(4)
...
def room_five_a():
    """
    Introduction text to Room five A.
    Provides the player an option to pick up
    a weapon and changes the weapon attack
    """
...
def room_five_a_1():
    """
    If the player chooses option 1 to pick
    up the weapon
    """
...
def room_five_a_2():
    """
    If the player chooses option 2 to
    not pick up the weapon
    """
...
def room_five_a_rested():
    """
    If the player earlier picked the option
    to rest in Room four
    """
...
def room_five_a_not_rested():
    """
    If the player earlier didn't pick the option
    to rest in Room four
    """
...
def room_five_b():
    """
    Introduction text to Room five B.
    Provides the player an option to pick up
    a weapon and changes the weapon attack
    """
...
def room_five_b_weapon():
    """
    Prompts the player to make a choice about
    picking up a weapon
    """
...
def room_six():
    """
    Introduction text to Room six
    """

    print("\n\nPushing forward, your main destination is downward as there")
    print("must be a door somewhere to leave this horrendous place, ")
...
def room_seven_ending_1():
    """
    If the player is rested and picked up a weapon and chooses
    option in Room seven 1 when prompted
    """
...
def room_seven_ending_2():
    """
    If the player is rested and picked up a weapon and chooses
    option in Room seven 2 when prompted
    """
...
def room_seven_injury():
    """
    Intro to Room seven, the final room,
    if the player didn't rest in Room four
    """
...
def room_seven_ending_3():
    """
    If the player is not rested and picked up a weapon and chooses
    option 1 in Room seven when prompted
    """
...
def room_seven_ending_4():
    """
    If the player is rested and picked up a weapon and chooses
    option 2 in Room seven when prompted
    """
...
def room_seven_insta_death_no_injury():
    """
    Intro to Room seven, the final room,
    if the player rested in Room four and didn't
    pick up a weapon
    """
...
def room_seven_insta_death_injury():
    """
    Intro to Room seven, the final room,
    if the player is not rested in Room four and didn't
    pick up a weapon
    """
    print("\n\nSlowly, hindered by your wound, you make it downstairs.")
    print("Though, even the pain doesn't dampen the relief ")
