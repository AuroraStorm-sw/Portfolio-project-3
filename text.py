...
def room_four_choice_three():
    ...
    # time.sleep(3)
    print("Shaking, you safely make it through the door and down a slim flight of stairs.")


def room_four_choice_four_text():
...
def room_six_a_choice_two():
    ...
    print("Only when they've both disappeared do you dare move and hurry in the opposite direction,")
    print("as gut-wrenching screams echo behind you.")

def room_six_a_choice_three():
    print("Frozen in fear, you remain in your spot, but it doesn't take long before the figure returns ")
...
def room_seven_ending_1():
    ...
    win_game()
    print("ending 1")# TEST = FUNCTIONAL
